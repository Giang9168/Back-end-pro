...
namespace Qtht.Data.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, Qtht.Data.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((Qtht.Data.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public ProductEntityFactory() : base("ProductEntity", Qtht.Data.EntityType.ProductEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(Qtht.Data.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(Qtht.Data.EntityType)))
			{
				var factory = GetFactory((Qtht.Data.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Qtht.Data.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Qtht.Data.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
	...
	{
		/// <summary>Gets the factory of the Entity type with the Qtht.Data.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Qtht.Data.EntityType)Enum.Parse(typeof(Qtht.Data.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((Qtht.Data.EntityType)Enum.Parse(typeof(Qtht.Data.EntityType), leftOperandEntityName, false), joinType, (Qtht.Data.EntityType)Enum.Parse(typeof(Qtht.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (Qtht.Data.EntityType)Enum.Parse(typeof(Qtht.Data.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((Qtht.Data.EntityType)entityTypeValue); }
